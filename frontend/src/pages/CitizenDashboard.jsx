...
export default function CitizenDashboard() {
  ...
  const handleFormSubmit = (e) => {
    ...
    setTimeout(() => {
      const complaintData = {
        text: description || 'Voice complaint submitted.',
        category,
        type: reportMethod,
        media_url: photoUrl,
        audio_url: audioUrl,
        user: user?.email || 'guest@demo.com',
        latitude: locationCoords?.lat || 19.1155 + (Math.random() - 0.5) * 0.02,
        longitude: locationCoords?.lon || 72.8755 + (Math.random() - 0.5) * 0.02
      };
              ...
              <div className="bg-white/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-white/60 shadow-xl shadow-blue-100/40 lg:col-span-2 space-y-6 relative overflow-hidden group">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { key: 'voice', icon: <Mic className="w-6 h-6 mb-2" />, label: '🎙️ Speak (Voice)' },
                  ...
                  {reportMethod === 'voice' && (
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200/60 space-y-5">
                      ...
                      <div className="text-center">
                        <h4 className="text-base font-bold text-slate-700">🎙️ "Boliye, aapki kya samasya hai?"</h4>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        placeholder={
                          reportMethod === 'text'
                            ? 'Write description here, or click the 🎤 mic icon to speak...'
                            : reportMethod === 'voice'
